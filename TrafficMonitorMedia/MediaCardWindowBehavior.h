...
namespace media
{
    ...
    inline constexpr int kMediaCardShowCommand = SW_SHOWNOACTIVATE;
    ...
    inline constexpr UINT kMediaCardInitialPositionFlags =
        kMediaCardAnimationPositionFlags | SWP_SHOWWINDOW;
}
