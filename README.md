...
- 鼠标滚轮可配置为：
  ...
  - 上一/下一媒体会话
  - 增减系统音量
- 系统音量增减支持设置步长，默认 5%，范围 1–50%。
- 默认左键单击播放/暂停，左键双击下一首，滚轮切换媒体会话。
- 支持深色/浅色任务栏和 DPI 缩放。
...
系统音量步长以百分比设置，默认 5%，有效范围 1–50%。这里控制的是 Windows 当前默认播放设备的系统主音量，不是单个播放器的应用音量。
...
- GSMTC 没有标准歌词字段，版本 1.0.2 不支持歌词显示。
